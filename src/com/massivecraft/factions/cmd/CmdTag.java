...
public class CmdTag extends FCommand
{
	...
	public void perform()
	{
		...
		// Inform
		myFaction.msg("%s<i> a changé le nom de faction en %s", fme.describeTo(myFaction, true), myFaction.getTag(myFaction));
		for (Faction faction : Factions.i.get())
		{
			...
			faction.msg("<i>La faction %s<i> a changé son nom en %s.", fme.getColorTo(faction)+oldtag, myFaction.getTag(faction));
		}
	}
