...
public class CmdInvite extends FCommand
{
	...
	public void perform()
	{
		...
		you.msg("%s<i> vous à invité à rejoindre la faction %s", fme.describeTo(you, true), myFaction.describeTo(you));
		myFaction.msg("%s<i> à invité %s<i> dans votre faction.", fme.describeTo(myFaction, true), you.describeTo(myFaction));
	}
