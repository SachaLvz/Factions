...
public class CmdHome extends FCommand
{
	...
	public void perform()
	{
		...
		{
			fme.msg("<b>Votre faction n'a pas de home. ");
		...
		{
			fme.msg("<b> Vous ne pouvez pas vous téléporter au home de votre faction lorsque vous êtes sur le territoire d'une faction ennemie.");
			return;
		}
		
		if ( ! Conf.homesTeleportAllowedFromDifferentWorld && me.getWorld().getUID() != myFaction.getHome().getWorld().getUID())
		{
			fme.msg("<b> Vous ne pouvez pas vous téléporter au home de votre faction dans un monde différent.");
			return;
		}
		...
		)
		{
			...
			for (Player p : me.getServer().getOnlinePlayers())
			{
				...
				fme.msg("<b>Vous ne pouvez pas vous téléporter car il y a des ennemies dans les " + Conf.homesTeleportAllowedEnemyDistance + " blocs.");
				return;
			}
		}
